; This is a modified copy of https://github.com/tristanstraub/cljs-google-signin/blob/master/src/cljs_google_signin/component.cljs
; The modifications were made to cause cljs to stop complaining about not conforming to the spec, and to make it
; easier to style the thing.
